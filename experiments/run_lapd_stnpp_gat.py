...
from experiments.lapd_target_common import (
    TARGET_CRIME_ORDER,
    TargetDataset,
    load_target_dataset,
...
from models.stnpp_gat import MarkGraphAttention, STNPPGATConfig, transition_kl_loss
...
def main() -> None:
    args = parse_args()
    result_dir = ROOT / "results" / "STNPP_GAT" / args.run_id
